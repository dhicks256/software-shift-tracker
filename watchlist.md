...
| **Cognition / Devin** | Pricing collapsed $500 → $20/mo; now enterprise-dominant | **$1B Series D closed May 27 at $25B pre-money; $492M ARR; 50% MoM enterprise growth 6 months; customers: Mercedes-Benz, NASA, Goldman Sachs** | IPO signals; enterprise churn at $492M ARR scale |
| **Harvey** | Cleanest of the cohort; $11B valuation (Mar 2026) | **$195M ARR (Sacra est.); $200M raised at $11B (Mar 2026); Singapore office Jun 2026; Chicago Jul 2026; Paris opened May 2026** | M&A activity, IPO signals, whether Legora eats into BigLaw share |
...
| Entity | Move | Watch for |
|---|---|---|
| **Sigma** | **"Agent Skills" + Call API action GA May 8 2026 — building for agent-as-user** | Pricing changes, Looker migrations |
| **Hex** | One-click data-scientist → app | Magic feature adoption |
...
| Entity | Move | Watch for |
|---|---|---|
| **Salesforce** | **Q1 FY27: Agentforce ARR $1.2B (205% YoY); 3.8B AWUs (+111% QoQ); Agentforce+Data360 combined $3.4B ARR; FY27 guidance raised to $45.9–46.2B** | Whether pace continues to accelerate; seat-license erosion disclosure |
...
| **Atlassian** | Rovo bundled free Apr 9 2025 | **Q3 FY2026 (Apr 30): first-ever enterprise seat count decline reported; attributed to AI agent adoption; cloud revenue +29% YoY offset; Service Collection >$1B ARR** | Whether Q4 FY2026 (Jul 2026) confirms seat decline trend; any explicit AI attribution language |
| **Gong** | **ARR topped $500M, 55%+ YoY, 10th straight accelerating quarter (May 12 2026)** | Whether AI-native acceleration holds |
| **HubSpot** | **$0.50/resolved conversation (April 14 2026 Breeze repricing); 8,000+ activations; 65% resolution rate** | Whether Intercom/Zendesk respond to pricing undercut |
| **Snowflake** | Cortex consumption | **Q1 FY27 (May 27): product rev $1.33B (+34% YoY, accelerating from 30%); NRR 126%; Snowflake Intelligence doubled QoQ** | Whether 34% growth holds through Q2; Intelligence attach rate |
| **Workday** | 8.5% layoffs early 2025 | Whether they ship credible agent SKUs |

## Solopreneur / micro-SaaS portfolio

| Entity | Last disclosure | Watch for |
|---|---|---|
| **Pieter Levels (PhotoAI)** | $80-120K MRR, drifting down | Recovery, new product launch, or further decline |
| **Marc Lou (ShipFast)** | Declined in 2025 from $1M+ lifetime peak | Pivot or new product |
| **Tony Dinh (TypingMind)** | Slowed after ChatGPT projects/memory | New vertical product |
...
- **Will any public SaaS company file a disclosure attributing seat contraction to AI?** **FIRED (partially):** Atlassian Q3 FY2026 (Apr 30) reported first-ever enterprise seat count decline with AI agent adoption cited as primary driver. Cloud revenue +29% YoY offset the seat decline. GitLab also noted seat contraction tied to customer layoffs. No SEC filing with explicit AI attribution yet — watch Q4 FY2026 earnings cycles (Jul–Aug 2026).
...
- **Will Cognition/Devin disclose real ARR and customer count?** **RESOLVED (May 27):** $492M ARR, 50% MoM enterprise growth for 6 months, customers include Mercedes-Benz, NASA, Goldman Sachs. $1B Series D closed at $25B pre-money. Watch for IPO signals and churn at scale.
...
- **Will Cursor's lead survive Claude Code maturity?** SpaceX IPO June 12 on track; Cursor acquisition (~July) now under regulatory scrutiny (antitrust + xAI "gun-jumping" concerns). Google Antigravity 2.0 + Gemini CLI sunset (June 18) adds a third serious contender. Anthropic $65B Series H ($47B run-rate) accelerates Claude model velocity — three-way race between Antigravity, Claude Code, and GitHub Copilot for enterprise developer share.

## AaaS / foundation — additional entities

| Entity | Why we watch | Last known signal | Watch for |
|---|---|---|---|
| **Anthropic** | Near-$1T valuation; $47B run-rate; Claude underlies much of the AaaS stack | **$65B Series H at $965B post-money (May 28 2026); IPO widely expected next** | IPO timing; Claude 4.x model release; whether Karpathy pretraining bet pays off |
| **Legora** | $5.55B legal AI; Harvey-class but cross-vertical (hotels, casinos) | **$550M Series D (2026); clients include Marriott, Caesars** | Harvey vs. Legora BigLaw market share; cross-vertical expansion |

## Add candidates (to vet next week)

*(Google Antigravity moved to main Embedded AI Analytics table above)*
